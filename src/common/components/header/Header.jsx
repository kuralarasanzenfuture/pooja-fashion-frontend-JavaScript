...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-xl border-b border-slate-200/80 shadow-[0_4px_20px_-4px_rgba(15,28,63,0.06)] shrink-0">
      ...
      <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="hidden xl:flex items-center flex-1 max-w-md mx-4">
          <Link
            to={ROUTES.PRODUCTS}
            className="w-full flex items-center justify-between px-3.5 py-1.5 rounded-full bg-slate-100/70 hover:bg-slate-100 border border-slate-200/80 text-slate-400 hover:text-slate-600 transition-all text-xs shadow-2xs group"
          >
            <div className="flex items-center gap-2">
              <Search className="w-3.5 h-3.5 text-slate-400 group-hover:text-[#1e3a8a] transition-colors" />
              <span className="text-slate-500 font-medium">
                Search lehengas, silk sarees, invoices...
              </span>
            </div>
            <kbd className="hidden sm:inline-flex items-center gap-0.5 px-2 py-0.5 text-[10px] font-mono font-bold bg-white text-slate-500 rounded-full border border-slate-200/80 shadow-2xs">
              ⌘K
            </kbd>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="hidden md:flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-gradient-to-r from-[#f0f4fc] to-[#e8eefa] border border-[#c7d2fe] text-[#0f1c3f] text-xs font-semibold shadow-2xs">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
              <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500" />
            </span>
            <span className="font-bold text-[11px] text-[#0f1c3f]">Live Counter #01</span>
          </div>
