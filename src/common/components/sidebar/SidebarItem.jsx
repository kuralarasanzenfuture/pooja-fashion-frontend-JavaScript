        ...
        <div className="absolute left-full top-0 ml-2 w-60 bg-base-100 text-base-content rounded-2xl shadow-2xl border border-base-300 py-2.5 px-1.5 z-50 animate-in fade-in zoom-in-95 duration-150">
          <div className="px-3 py-1.5 mb-1.5 border-b border-base-200 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-bold text-base-content">{item.title}</span>
            </div>
            {item.badge && (
              <span className="px-2 py-0.5 text-xs font-bold rounded-full bg-primary/15 text-primary">
                {item.badge}
...
function SubMenuItem({ item, onNavigate, onLogout }) {
      ...
      <div className="space-y-0.5">
        <button
          ...
          className={`w-full flex items-center justify-between px-3 py-2 rounded-xl text-sm font-semibold transition-colors text-left cursor-pointer ${
            nestedOpen
              ? "text-base-content font-bold bg-base-200/60"
  ...
  return (
    <NavLink
      ...
      onClick={onNavigate}
      className={() =>
        `flex items-center justify-between px-3 py-2 rounded-xl text-sm font-semibold transition-all ${isItemActive
          ? "bg-primary text-primary-content font-bold shadow-xs"
          : "text-base-content/70 hover:text-base-content hover:bg-base-200/70"
        }`
      }
