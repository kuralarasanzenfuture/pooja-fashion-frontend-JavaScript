    ...
    <>
      ...
      <div className="not-found-page">
        <div className="not-found-page__content">
          <svg id="svgWrap_2" className="not-found-page__svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 700 250" aria-hidden="true">
            <g>
          ...
          <svg id="svgWrap_1" className="not-found-page__svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 700 250" aria-hidden="true">
            <g>
          ...
          <svg aria-hidden="true" className="not-found-page__glow" viewBox="0 0 700 250" preserveAspectRatio="none">
            <defs>
              <filter id="glow">
